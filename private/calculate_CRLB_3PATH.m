function [CRLB] =  calculate_CRLB_3PATH(Nfits, PSF, sz, phi0, Theta)
pi = single(3.141592);
...
for tx = 1:Nfits
    ...
    for ii = 1:sz
        for jj = 1:sz
            ...
            [dudt, model] =  kernel_DerivativeSpline_v3(ii+xstart+off, jj+ystart+off, zstart, spline_xsize, spline_ysize, spline_zsize, delta_f, delta_dxf, delta_dyf, delta_dzf, PSF, squeeze(Theta(tx, :)), NV, phi0);
